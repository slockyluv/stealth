...
import { buildCompanyCountrySelectionView } from '../../features/registration/privateCompanySelectionView.js';
...
export const companyContinentSelect: SelectMenuHandler = {
  key: 'companyReg:continent',
